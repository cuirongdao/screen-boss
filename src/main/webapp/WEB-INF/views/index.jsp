...
<body background="backgroud.jpg" onLoad="init()">
	...
	<script type="text/javascript">
		...
		function displayAengtStatChart(ready, notReady, acw, busy) {
			var myChart1t = new FusionCharts("FusionCharts/Pie3D.swf",
					"myChartId1", "300", "320");
			if (!ready && !notReady && !acw && !busy) {
				ready = 1;
				notReady = 1;
				acw = 1;
				busy = 1;
			...
			var dataXml = "<graph alternateHGridAlpha='60' alternateHGridColor='f8f8f8' bgAlpha='70'  bgColor='#26456c' baseFontColor='#fbfbfd' caption='坐席状态图' decimalPrecision='0' divLineAlpha='60' divlinecolor='c5c5c5' numberPrefix='' showAlternateHGridColor='1' showColumnShadow='1' showValues='0' xAxisName='Month' yAxisName='Revenue'><set isSliced='1' label='就绪人数' value='" + ready + "'/><set label='离席人数' value='" + notReady + "'/><set isSliced='1' label='话后处理人数' value='" + acw + "'/><set isSliced='1' label='通话人数' value='" + busy + "'/><trendlines><line color='91C728' displayValue='Target' showOnTop='1' startValue='26000'/></trendlines></graph>";

			myChart1t.setDataXML(dataXml);
			myChart1t.render("chartdiv2");
